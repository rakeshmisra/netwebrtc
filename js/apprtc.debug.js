(function(f) {
  ...
  return function e(t, n, r) {
    ...
    module.exports = function(window, edgeVersion) {
      ...
      RTCPeerConnection.prototype.addIceCandidate = function(candidate) {
        ...
        if (!candidate || candidate.candidate === "") {
          ...
          if (!(candidate.sdpMLineIndex !== undefined || candidate.sdpMid)) {
    ...
    module.exports = {shimOnTrack:firefoxShim.shimOnTrack, shimSourceObject:firefoxShim.shimSourceObject, shimPeerConnection:firefoxShim.shimPeerConnection, shimRemoveStream:firefoxShim.shimRemoveStream, shimGetUserMedia:require("./getusermedia")};
    ...
    module.exports = {shimCallbacksAPI:safariShim.shimCallbacksAPI, shimLocalStreamsAPI:safariShim.shimLocalStreamsAPI, shimRemoteStreamsAPI:safariShim.shimRemoteStreamsAPI, shimGetUserMedia:safariShim.shimGetUserMedia, shimRTCIceServerUrls:safariShim.shimRTCIceServerUrls, shimTrackEventTransceiver:safariShim.shimTrackEventTransceiver, shimCreateOfferLegacy:safariShim.shimCreateOfferLegacy};
